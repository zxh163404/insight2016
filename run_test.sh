...
python ./src/antifraud.py ./paymo_input/batch_payment_test.csv ./paymo_input/stream_payment_test.csv ./paymo_output/output1.txt ./paymo_output/output2.txt ./paymo_output/output3.txt
